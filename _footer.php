  ...
  <div class="container pt-5 border-bottom">
    <div class="row">
      <div class="col-md-3 col-sm-12 mb-3 text-center">
        <img src="img/footer.png" class="img-fluid" width="100px" height="30px"  viewBox="0 0 200 60">
                <defs>
      ...
      <div class="col-md-9 col-sm-12">
        ...
        <div class="col-md-3 col-sm-6 col-6 p-0 float-left mb-3">
          <h5 class="mb-4 font-weight-bold text-uppercase">Facebook</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://web.facebook.com/aldhy.bmc.3" target="_blank"><i class="fa fa-facebook mr-1"></i> Facebook</a>
          </li>
        </ul>
        </div>

        <div class="col-md-3 col-sm-6 col-6 p-0 mb-3 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">Location</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://goo.gl/maps/dKPh4LQh2T4JMf5F6"><i class="fa fa-map mr-1"></i> Google Map</a></li>
        </ul>
        </div>

        <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">Instagram</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://www.instagram.com/fireworks.store/" target="_blank"><i class="fa fa-instagram mr-1"></i> Instagram</a>
          </li>
        </ul>
        </div>

        <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">WhatsApp</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://wa.me/6282339418299?text=" target="_blank"><i class="fa fa-whatsapp mr-1"></i> WhatsApp</a>
          </li>
        </ul>
        </div>
        ...
        <div class="col-md-12">
          <div class="py-4 d-flex justify-content-center align-items-center">
            <small>Copyright &copy Rizal Pebianto & Galfint Jimmy</small>
          </div>
        </div>
    </div>
  </div>
